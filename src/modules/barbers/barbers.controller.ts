...
export class BarbersController {
  ...
  @ApiResponse({ status: 201, description: 'Barber profile created successfully', type: BarberResponseDto })
  async createBarber(
  ...
  @ApiResponse({ status: 200, description: 'Barber profile updated successfully', type: BarberResponseDto })
  async updateBarber(
    @CurrentUser() user: any,
  ...
  @ApiResponse({ status: 200, description: 'Nearby barbers retrieved successfully', type: [BarberResponseDto] })
  ...
  async getAllBarbers(@Query() paginationDto: PaginationDto) {
    return this.barbersService.getAllBarbers(paginationDto.page, paginationDto.limit);
  }
  ...
  @ApiResponse({ status: 200, description: 'Barber profile retrieved successfully', type: BarberResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Barber retrieved successfully', type: BarberResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Status updated successfully', type: BarberResponseDto })
  async updateStatus(
    @CurrentUser() user: any,
