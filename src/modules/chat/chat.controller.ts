...
async createConversation(
  ...
  async getMessages(
    ...
    return this.chatService.getMessages(id, user.userId, paginationDto.page, paginationDto.limit);
  }
  ...
  @ApiQuery({ name: 'conversationId', description: 'Conversation ID (optional)', required: false })
